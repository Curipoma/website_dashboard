  ...
  setMessage() {
    if (this._touched || this._dirty) {
      if (this._errors) {
        ...
        this.renderer.addClass(this.nativeElement, 'incorrect-field');
        this.renderer.removeClass(this.nativeElement, 'correct-field');
      } else {
        this.nativeElement.innerText = this.messageService.correctField;
        this.renderer.addClass(this.nativeElement, 'correct-field');
        this.renderer.removeClass(this.nativeElement, 'incorrect-field');
      }
    }
  }
}
